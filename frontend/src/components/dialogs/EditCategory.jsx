...
import { DialogContent, Dialog, TextField, DialogActions, Button, DialogTitle, makeStyles } from '@material-ui/core'
...
export default ({ payload, callback }) => {
    ...
    const { register, handleSubmit, errors } = useForm({ mode: 'onBlur', defaultValues: category });
